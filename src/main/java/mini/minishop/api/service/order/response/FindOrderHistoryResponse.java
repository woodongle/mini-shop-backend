...
public class FindOrderHistoryResponse {
    ...
    @Builder
    public FindOrderHistoryResponse(Long orderId, OrderStatus orderStatus, LocalDateTime orderedDate,
                                    LocalDateTime canceledDate, List<OrderGoodsResponse> orderGoods) {
